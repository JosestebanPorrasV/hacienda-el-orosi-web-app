  ...
  return (
    <>
      <div className="bg-gray-700 rounded-lg px-4 lg:px-8 py-4 lg:py-6 mt-8 flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-12">
        <div>
          <h2 className="text-xl text-blue-200 font-bold mb-2">Acciones rapidas</h2>
        ...
        <nav className="md:flex md:space-x-4 space-y-2 md:space-y-0">
          ...
          >
            ...
            <span className="text-blue-100 opacity-70">Registrar </span>
          </a>
          <a
            href="/"
            className="inline-flex flex-col justify-center items-center px-3 py-3 border border-gray-600 rounded-lg hover:bg-gray-800 w-32"
          >
            ...
            <span className="text-blue-100 opacity-70">Listar todos</span>
          </a>
          <a
            href="/"
            className="inline-flex flex-col justify-center items-center px-3 py-3 border border-gray-600 rounded-lg hover:bg-gray-800 w-32"
          >
            ...
            <span className="text-blue-100 opacity-70">Trabajos</span>
          </a>
          <a
            href="#/"
            className="inline-flex flex-col justify-center items-center px-3 py-3 border border-gray-600 rounded-lg hover:bg-gray-800 w-32"
          >
            ...
            <span className="text-blue-100 opacity-70">Liquidar</span>
          </a>
        </nav>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 2xl:gap-8 pt-10">
          ...
          <div className="col-span-1 bg-gray-700 rounded-lg px-4 lg:px-8 py-4 lg:py-6">
            <h2 className="text-xl text-blue-200 font-bold mb-4 lg:mb-6">Todal de pagos</h2>
          ...
          <div className="col-span-1 bg-gray-700 rounded-lg px-4 lg:px-8 py-4 lg:py-6">
            <h2 className="text-xl text-blue-200 font-bold mb-4 lg:mb-6">Total de colaboradores</h2>
            <div className="flex space-x-4 items-end mb-4 lg:mb-6">
              <div className="w-12 h-12 rounded-lg bg-blue-900 flex items-center justify-center">
          ...
          <div className="col-span-1 bg-gray-700 rounded-lg px-4 lg:px-8 py-4 lg:py-6">
            <h2 className="text-xl text-blue-200 font-bold mb-4 lg:mb-6">Herramientas utilizadas</h2>
            <div className="flex space-x-4 items-end mb-4 lg:mb-6">
              <div className="w-12 h-12 rounded-lg bg-blue-900 flex items-center justify-center">
                <svg className="w-6 h-6 text-blue-100" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
