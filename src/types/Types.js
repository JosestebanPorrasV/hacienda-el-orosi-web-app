export const Types = {
  ...
  UI_OPEN_MODAL_HEALTH: 'UI_OPEN_MODAL_HEALTH',
  UI_CLOSE_MODAL_HEALTH: 'UI_CLOSE_MODAL_HEALTH',
  UI_OPEN_MODAL_MEDICAMENT: 'UI_OPEN_MODAL_MEDICAMENT',
  UI_CLOSE_MODAL_MEDICAMENT: 'UI_CLOSE_MODAL_MEDICAMENT',
  ...
  //HEALTH
  HEALTHS_LOADED: 'HEALTHS_LOADED',
  ADD_HEALTH: 'ADD_HEALTH',
  UPDATED_HEALTH: 'UPDATED_HEALTH',
  DELETE_HEALTH: 'DELETE_HEALTH',
  HEALTH_SET_ACTIVE: 'HEALTH_SET_ACTIVE',
  HEALTH_CLEAR_ACTIVE: 'HEALTH_CLEAR_ACTIVE',

  //MEDICAMENT
  MEDICAMENTS_LOADED: 'MEDICAMENTS_LOADED',
  ADD_MEDICAMENT: 'ADD_MEDICAMENT',
  UPDATED_MEDICAMENT: 'UPDATED_MEDICAMENT',
  DELETE_MEDICAMENT: 'DELETE_MEDICAMENT',
  MEDICAMENT_SET_ACTIVE: 'MEDICAMENT_SET_ACTIVE',
  MEDICAMENT_CLEAR_ACTIVE: 'MEDICAMENT_CLEAR_ACTIVE',
